...
var useForceUpdate = function () {
    var _a = (0, react_1.useState)(0), setTick = _a[1];
    var update = function () {
...
var useScroll = function () {
    var _a = (0, react_1.useState)((0, _1.getScrollTop)()), scrollTop = _a[0], setScrollTop = _a[1];
...
var useScrolling = function (element, delay) {
    var _a = (0, react_1.useState)(false), scrolling = _a[0], setScrolling = _a[1];
    (0, react_1.useEffect)(function () {
