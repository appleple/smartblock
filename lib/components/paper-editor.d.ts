...
export default class App extends React.Component<AppProps, AppState> {
    ...
    schema: Schema;
    static defaultProps: {
        extensions: (import("..").Paragraph | import("..").Heading2 | import("..").Heading3 | import("..").ListItem | import("..").BulletList | import("..").OrderedList | import("..").Table | import("../extensions/blockquote").default | import("..").Underline | import("..").Strike | import("..").Strong | import("..").Link | import("../extensions/em").default | import("..").Trash | import("..").MoveUp | import("..").MoveDown)[];
        offsetTop: number;
    };
