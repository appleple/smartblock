...
var MenuBar = function (_a) {
    ...
    return (React.createElement("div", { style: style, ref: container, className: "smartblock-inline-menu" },
        React.createElement("div", { className: "smartblock-inline-menu-arrow", style: { left: "".concat(pos, "px") } }),
        React.createElement("div", { className: "smartblock-inline-menu-inner" },
            children,
            menu.map(function (item, key) {
                return (React.createElement(button_1.default, { key: "inline-".concat(key), type: "button", active: item.active && item.active(state), 
                    // title={item.title}
