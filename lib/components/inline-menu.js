...
var calculateStyle = function (view, offsetTop) {
...
var MenuBar = function (_a) {
    var menu = _a.menu, children = _a.children, view = _a.view, offsetTop = _a.offsetTop;
    var style = calculateStyle(view, offsetTop);
