...
var calculateStyle = function (view, offsetHeight) {
...
var MenuBar = function (_a) {
    var menu = _a.menu, children = _a.children, view = _a.view, offsetHeight = _a.offsetHeight;
    var style = calculateStyle(view, offsetHeight);
