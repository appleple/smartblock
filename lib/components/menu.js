...
export default (function (props) {
    ...
    return (React.createElement(PositionBtnGroup, { style: style },
        React.createElement(PositionBtnGroupTop, null, menu.map(function (item, key) {
            ...
            return (React.createElement(ButtonStyle, { key: key, type: "button", active: item.active && item.active(state), title: item.title, disabled: (item.enable && !item.enable(state)) || hideMenuOnFocus, onClick: function (e) {
                    e.preventDefault();
