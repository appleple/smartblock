        ...
        React.createElement(Container, { full: props.full },
            ...
            React.createElement(Inner, null,
                React.createElement("div", { className: showMenus ? '' : 'ProseMirrorHideSelection', ref: container },
                    React.createElement(Input, null, options && React.createElement(Editor, { options: options, nodeViews: nodeViews, onChange: function (state, dispatch) {
                            ...
                            return (React.createElement(React.Fragment, null,
                                (showMenus) && React.createElement(React.Fragment, null,
                                    ...
                                    shouldRenderInlineMenu(view, blocks) && React.createElement(InlineMenu, { menu: getMenu(marks), blockMenu: getMenu(blocks), view: view }),
