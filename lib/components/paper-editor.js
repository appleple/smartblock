                ...
                React.createElement(Input, null,
                    React.createElement(Editor, { options: editorOptions, nodeViews: nodeViews, onChange: this.onChange, render: function (_a) {
                            ...
                            return (React.createElement(React.Fragment, null,
                                React.createElement(Menu, { view: view, menu: { blocks: _this.getMenu(blocks) } }),
                                React.createElement(EditMenu, { view: view, menu: { blocks: _this.getMenu(edits) } }),
                                React.createElement(InlineMenu, { menu: { marks: _this.getMenu(marks) }, view: view }),
                                editor));
                        } })))));
    };
    App.defaultProps = {
