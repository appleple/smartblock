...
var App = /** @class */ (function (_super) {
    ...
    function App(props) {
        ...
        _this.state = { doc: doc, containerId: uuid(), showMenus: true };
        return _this;
    }
    ...
    App.prototype.render = function () {
        ...
        var _b = this.state, doc = _b.doc, containerId = _b.containerId, showMenus = _b.showMenus;
        ...
        return (React.createElement("div", { id: containerId, onClick: this.clearSelection },
            React.createElement(Container, null,
                React.createElement("div", { className: showMenus ? '' : 'ProseMirrorHideSelection', ref: function (ref) {
