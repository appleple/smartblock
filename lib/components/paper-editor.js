...
export default (function (props) {
    ...
    var html = props.html, json = props.json, extensions = props.extensions, showBackBtn = props.showBackBtn;
                    ...
                    React.createElement(Editor, { options: editorOptions, nodeViews: nodeViews, onChange: function (state, dispatch) {
                            ...
                            return (React.createElement(React.Fragment, null,
                                showMenus && React.createElement(React.Fragment, null,
                                    ...
                                    React.createElement(InlineMenu, { menu: getMenu(marks), view: view }),
