...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        var _this = this;
        var _a = this.props, extensions = _a.extensions, offsetTop = _a.offsetTop;
        ...
        return (React.createElement(Container, null,
            React.createElement("div", { id: "container", ref: function (ref) {
                    _this.container = ref;
                } },
                React.createElement(Input, null,
                    React.createElement(Editor, { options: editorOptions, nodeViews: nodeViews, onChange: this.onChange, render: function (_a) {
                            var editor = _a.editor, view = _a.view;
                            return (React.createElement(React.Fragment, null,
                                React.createElement(Menu, { view: view, menu: { blocks: _this.getMenu(blocks) }, offsetTop: offsetTop }),
                                React.createElement(EditMenu, { view: view, menu: { blocks: _this.getMenu(edits) }, offsetTop: offsetTop }),
                                React.createElement(InlineMenu, { menu: { marks: _this.getMenu(marks) }, view: view, offsetTop: offsetTop }),
                                editor));
                        } })))));
    };
    App.defaultProps = {
