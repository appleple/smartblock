...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        var _this = this;
        var _a = this.props, extensions = _a.extensions, offsetHeight = _a.offsetHeight;
                ...
                React.createElement(Input, null,
                    React.createElement(Editor, { options: editorOptions, nodeViews: nodeViews, onChange: this.onChange, render: function (_a) {
                            ...
                            return (React.createElement(React.Fragment, null,
                                React.createElement(Menu, { view: view, menu: { blocks: _this.getMenu(blocks) }, offsetHeight: offsetHeight }),
                                React.createElement(InlineMenu, { menu: { marks: _this.getMenu(marks) }, view: view, offsetHeight: offsetHeight }),
                                editor));
                        } })))));
    };
    App.defaultProps = {
