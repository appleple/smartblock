...
var BulletList = /** @class */ (function () {
    ...
    Object.defineProperty(BulletList.prototype, "icon", {
        get: function () {
            return React.createElement(react_fontawesome_1.default, { icon: fontawesome_free_solid_1.faList });
        },
        enumerable: true,
        configurable: true
    });
    BulletList.prototype.active = function (state) {
        return util_1.blockActive(state.schema.nodes.bullet_list)(state);
    };
