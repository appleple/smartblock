...
var calculateStyle = function (view) {
    ...
    var app = view.dom;
    var link = (0, utils_1.getMarkInSelection)('link', view.state);
    ...
    var top = coords.top + (0, utils_1.getScrollTop)() + ARROWTOPOFFSET;
...
var TooltipComponent = function (props) {
    ...
    return (React.createElement("div", { className: "smartblock-tooltip-wrap", ref: container, style: style },
        React.createElement("div", { className: "smartblock-tooltip-arrow", style: { left: "".concat(arrowPos, "px") } }),
...
var Tooltip = /** @class */ (function () {
    ...
    // @ts-ignore
    Tooltip.prototype.update = function (view, prevState) {
        (0, react_1.render)(React.createElement(TooltipComponent, { view: view }), this.tooltip);
    };
    Tooltip.prototype.destroy = function () {
        (0, react_1.unmount)(this.tooltip);
        document.body.removeChild(this.tooltip);
    };
    return Tooltip;
}());
