    ...
    TooltipReact.prototype.render = function () {
        ...
        return (React.createElement(Tooltip, { style: style },
            editing && React.createElement(React.Fragment, null,
                React.createElement(Input, { type: "text", value: newUrl, placeholder: "\u30EA\u30F3\u30AFURL\u3092\u5165\u529B", onKeyDown: function (e) {
                        if (e.key === 'Enter') {
                            _this.enterUrl();
                        }
                    }, onChange: function (e) {
                ...
                React.createElement(Button, { onClick: this.enterUrl }, "OK")),
            !editing && React.createElement(React.Fragment, null,
                React.createElement(Label, { onClick: function () {
                        _this.setState({
                            editing: true
                        });
                    } }, newUrl),
