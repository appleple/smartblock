...
var Heading5 = /** @class */ (function (_super) {
    ...
    Heading5.prototype.active = function (state) {
        return (0, utils_1.blockActive)(state.schema.nodes.heading5)(state);
    };
    Heading5.prototype.enable = function (state) {
        return (0, prosemirror_commands_1.setBlockType)(state.schema.nodes.heading5)(state);
    };
    Heading5.prototype.customMenu = function (_a) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(button_1.default, { active: node && node.attrs.align === 'left', type: "button", onClick: function () {
                    (0, prosemirror_commands_1.setBlockType)(state.schema.nodes.heading5, {
                        align: 'left',
                    })(state, dispatch);
                } },
    ...
    Heading5.prototype.onClick = function (state, dispatch) {
        (0, prosemirror_commands_1.setBlockType)(state.schema.nodes.heading5)(state, dispatch);
    };
    return Heading5;
}(types_1.Extension));
