...
var Heading6 = /** @class */ (function (_super) {
    ...
    Heading6.prototype.active = function (state) {
        return (0, utils_1.blockActive)(state.schema.nodes.heading6)(state);
    };
    Heading6.prototype.enable = function (state) {
        return (0, prosemirror_commands_1.setBlockType)(state.schema.nodes.heading6)(state);
    };
    Heading6.prototype.customMenu = function (_a) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(button_1.default, { active: node && node.attrs.align === 'left', type: "button", onClick: function () {
                    (0, prosemirror_commands_1.setBlockType)(state.schema.nodes.heading6, {
                        align: 'left',
                    })(state, dispatch);
                } },
    ...
    Heading6.prototype.onClick = function (state, dispatch) {
        (0, prosemirror_commands_1.setBlockType)(state.schema.nodes.heading6)(state, dispatch);
    };
    return Heading6;
}(types_1.Extension));
