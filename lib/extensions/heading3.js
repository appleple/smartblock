...
var Heading3 = /** @class */ (function (_super) {
    ...
    Heading3.prototype.active = function (state) {
        return (0, utils_1.blockActive)(state.schema.nodes.heading3)(state);
    };
    Heading3.prototype.enable = function (state) {
        return (0, prosemirror_commands_1.setBlockType)(state.schema.nodes.heading3)(state);
    };
    Heading3.prototype.customMenu = function (_a) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(button_1.default, { active: node && node.attrs.align === 'left', type: "button", onClick: function () {
                    (0, prosemirror_commands_1.setBlockType)(state.schema.nodes.heading3, {
                        align: 'left',
                    })(state, dispatch);
                } },
    ...
    Heading3.prototype.onClick = function (state, dispatch) {
        (0, prosemirror_commands_1.setBlockType)(state.schema.nodes.heading3)(state, dispatch);
    };
    return Heading3;
}(types_1.Extension));
