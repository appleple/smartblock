...
var Paragraph = /** @class */ (function () {
    ...
    Object.defineProperty(Paragraph.prototype, "icon", {
        get: function () {
            return React.createElement(Icon, { src: paragraph, width: 24, height: 24 });
        },
        enumerable: true,
        configurable: true
    });
    ...
    Paragraph.prototype.customMenu = function (_a) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(Button, { type: "button", onClick: function () {
                ...
                React.createElement(Icon, { src: alignLeft, width: 24, height: 24 })),
            React.createElement(Button, { type: "button", onClick: function () {
                    setBlockType(state.schema.nodes.paragraph, {
                        align: 'center'
                    })(state, dispatch);
                } },
                React.createElement(Icon, { src: alignCenter, width: 24, height: 24 })),
            React.createElement(Button, { type: "button", onClick: function () {
                    setBlockType(state.schema.nodes.paragraph, {
                        align: 'right'
                    })(state, dispatch);
                } },
                React.createElement(Icon, { src: alignRight, width: 24, height: 24 }))));
    };
