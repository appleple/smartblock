...
var Paragraph = /** @class */ (function (_super) {
    ...
    Paragraph.prototype.active = function (state) {
        return (0, utils_1.blockActive)(state.schema.nodes.paragraph)(state);
    };
    Paragraph.prototype.enable = function (state) {
        return (0, prosemirror_commands_1.setBlockType)(state.schema.nodes.paragraph)(state);
    };
    Paragraph.prototype.customMenu = function (_a) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(button_1.default, { type: "button", active: node && node.attrs.align === 'left', onClick: function () {
                    (0, prosemirror_commands_1.setBlockType)(state.schema.nodes.paragraph, {
                        align: 'left',
                    })(state, dispatch);
                } },
    ...
    Paragraph.prototype.onClick = function (state, dispatch) {
        (0, prosemirror_commands_1.setBlockType)(state.schema.nodes.paragraph)(state, dispatch);
    };
    return Paragraph;
}(types_1.Extension));
