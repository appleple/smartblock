...
var Image = /** @class */ (function (_super) {
                ...
                parseDOM: [
                    {
                        ...
                        getAttrs: function (dom) {
                            ...
                            return {
                                ...
                                size: (0, util_1.hasClass)(img, imgClassName) ? 'small' : 'full'
                            };
                        }
                    },
                    {
                        ...
                        getAttrs: function (dom) {
                            return {
                                ...
                                size: (0, util_1.hasClass)(dom, imgClassName) ? 'small' : 'full'
                            };
                        }
                    }
                ],
    ...
    Object.defineProperty(Image.prototype, "plugins", {
        // @ts-ignore
        get: function () {
            return [(0, plugins_1.MediaPlugin)()];
        },
        enumerable: false,
        configurable: true
    });
    Image.prototype.changeImage = function (state, dispatch, files) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, util_1.readFiles)(files)];
                    case 1:
                        items = _a.sent();
                        item = items[0];
                        if (!item) {
                    ...
                    case 2:
                        success = _a.sent();
                        if (success) {
                            (0, prosemirror_commands_1.setBlockType)(state.schema.nodes.image, {
                                src: success
                            })(state, dispatch);
                        }
                        _a.label = 3;
    ...
    Image.prototype.customMenu = function (_a) {
        var _this = this;
        var state = _a.state, dispatch = _a.dispatch;
        var node = (0, utils_1.findSelectedNodeWithType)(state.schema.nodes.image, state);
        return (React.createElement(React.Fragment, null,
            React.createElement(button_1.default, { type: "button", style: {
                    ...
                    (0, prosemirror_commands_1.setBlockType)(state.schema.nodes.image, attr)(state, dispatch);
                } },
    ...
    Image.prototype.active = function (state) {
        return (0, utils_1.blockActive)(state.schema.nodes.image)(state);
    };
    Image.prototype.enable = function (state) {
        return (0, prosemirror_commands_1.setBlockType)(state.schema.nodes.image)(state);
    };
    return Image;
}(types_1.Extension));
